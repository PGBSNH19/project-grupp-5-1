...
namespace Backend.Controllers
{
    ...
    public class CouponsController : ControllerBase
    {
        ...
        /// <response code="404">If there are no coupons stored in the database.</response>
        /// <response code="500">If the API caught an exception when attempting to fetch coupons.</response>    
        [HttpGet]
        ...
        /// <response code="404">If no coupon was found which matched the given Id.</response>
        /// <response code="500">If the API caught an exception when attempting to fetch a coupon.</response>    
        [HttpGet("{couponId}")]
        ...
        /// <response code="400">If the API failed to save the new coupon to the database.</response>
        /// <response code="500">If the API caught an exception when attempting to save a coupon.</response>    
        [HttpPost]
        ...
        /// <response code="404">If no coupon was found which matched the given Id.</response>
        /// <response code="400">If the API failed to save the updated coupon to the database.</response>
        /// <response code="500">If the API caught an exception when attempting to save a coupon.</response>  
        [HttpPut("{couponId}")]
        ...
        /// <response code="404">If no coupon was found which matched the given Id.</response>
        /// <response code="400">If the API failed to save changes to database after deleting the coupon.</response>
        /// <response code="500">If the API caught an exception when attempting to delete a coupon.</response>  
        [HttpDelete("{couponId}")]
